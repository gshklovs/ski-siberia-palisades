...
// The whole vehicle. specs/0041 §4.7 — the sled carries no rider of its own any
// more: the skinned `play:body` sits on it, posed by the `seat-sled` clip. `opts`
// is kept for the call sites; nothing reads it.
