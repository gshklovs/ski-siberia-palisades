...
// specs/0041 §4.7 — the bike carries NO rider of its own any more: the skinned
// `play:body` is the only rider anywhere, posed by the `seat-bike` clip and
// placed on this bike by the runtime mount copy + the per-model offset from
// bikeRider() (§3.8.1). `opts` is kept for the call sites; nothing reads it.
